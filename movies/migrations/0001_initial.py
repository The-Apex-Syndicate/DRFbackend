# Generated by Django 5.2.2 on 2025-06-15 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_url', models.TextField(blank=True, default='', max_length=500, null=True)),
                ('genres', models.ManyToManyField(blank=True, related_name='movie_genre', to='movies.genre')),
                ('production_companies', models.ManyToManyField(blank=True, related_name='movie_production_companies', to='movies.productioncompany')),
                ('production_countries', models.ManyToManyField(blank=True, related_name='movie_production_countries', to='movies.productioncountry')),
